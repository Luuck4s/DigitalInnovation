package com.digital.saladereuniao.demo.controller;

import com.digital.saladereuniao.demo.exceptions.ResourceNotFoundException;
import com.digital.saladereuniao.demo.model.Room;
import com.digital.saladereuniao.demo.repository.RoomRepository;
...
public class RoomController {
    ...
    public ResponseEntity<Room> getRoomById(@PathVariable(value = "id") long roomId) throws ResourceNotFoundException {
        Room room = roomRepository.findById(roomId).orElseThrow(() -> new ResourceNotFoundException("Room not foud: " + roomId));
    ...
    public Map<String, Boolean> deleteRoom(@PathVariable(value = "id") Long roomId) throws  ResourceNotFoundException {
        ...
        Map<String, Boolean> respoonse = new HashMap<>();
        respoonse.put("deleted", Boolean.TRUE);
        return respoonse;
    }
}
